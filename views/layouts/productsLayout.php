...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap CDN CSS -->
        <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous"> --> <!-- CDNs Blocked! -->
        ...
        <link rel="stylesheet" href="/css/products/Languages/English/app.css"> 
        <title><?php echo $this->title // Note: this page or $this are a View.php class object. $title is a View.php class property which is assigned in every view ?></title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <?php if (Application::$app->session->getFlashMessageFromSession('createProductSuccessFlashMessage') || Application::$app->session->getFlashMessageFromSession('updateProductSuccessFlashMessage') || Application::$app->session->getFlashMessageFromSession('deleteProductSuccessFlashMessage')): ?> 
                <div class="alert alert-success">
                    <?php echo Application::$app->session->getFlashMessageFromSession('createProductSuccessFlashMessage') ?> 
                    <?php echo Application::$app->session->getFlashMessageFromSession('updateProductSuccessFlashMessage') ?> 
                    <?php echo Application::$app->session->getFlashMessageFromSession('deleteProductSuccessFlashMessage') ?> 
                </div>
            <?php endif; ?>
